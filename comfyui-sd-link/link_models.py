...
def create_model_links():
    ...
    target_base_dir = r"D:\comfyui\qwen_Image_Edit_nunchaku\ComfyUI-aki-v2\ComfyUI\models"
    # 实际存放文件的目录（源位置 - 真实数据存放地）
    source_base_dir = r"G:\AiResource\comfyuiResource\models"
    
    # 需要处理的文件夹列表
    folders_to_link = [
        "audio_encoders", "checkpoints", "controlnet", "diffusion_models",
        "latent_upscale_models", "loras", "SEEDVR2", "model_patches",
